...
@section('content')
<section class="bg-gray-200 p-4 min-h-full" id="products">
    <header class="flex justify-between bg-gray-800 rounded-lg px-4 py-2"><span
            class="text-xl text-gray-100 font-thin tracking-wide">Products</span>
        <a href="/admin/products/create"><button class="btn-add-item text-gray-100 font-thin">Add Product <i
                    class="fas fa-plus"></i></button></a></header>
    <nav class=""></nav>
    ...
    <article class="flex flex-wrap items-stretch justify-start mt-5">
        ...
        <div id="{{ $product->id }}"
            ...
            <div class="flex items-start h-full">
                <p class="text-xs">{{ substr($product->description, 0, 50) }}...</p>
            </div>
