        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    id="grid-name" type="text" placeholder="Product Name" name="name" value="{{ $product->name }}">
                @error('name')
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <textarea
                    ...
                    id="grid-password" name="description" style="resize:none;">{{ $product->description }}</textarea>
