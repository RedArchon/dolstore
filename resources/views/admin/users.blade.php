...
<section class="bg-gray-200 w-3/4 p-4 min-h-full" id="users">
    <header class="flex justify-between bg-gray-800 rounded-lg px-4 py-2"><span
            class="text-xl text-gray-100 font-thin tracking-wide">Users</span><button
            class="btn-add-item text-gray-100 font-thin">Add User <i class="fas fa-plus"></i></button></header>
    <table class="mt-2 w-full">
        ...
        <tbody class="text-center">
            ...
            <tr class="even:bg-gray-300">
                ...
                <td><a href="#" class="p-3 hover:text-green-500"><i class="far fa-edit"></i></a></td>
